			...
			<div class="container">
				...
				<div class="float--right float--xs-none text-xs-center">
					...
					<ul class="header--topbar-social nav hidden-sm hidden-xxs">
						<li><a href="https://www.facebook.com/anmythic"><i class="fa fa-facebook"></i></a></li>
						<li><a href="http://x.com//"><i class="fa fa-twitter"></i></a></li>
				...
				<div class="col-md-4">
					...
					<p>
						<ul style="display: flex;" class="header--topbar-social nav hidden-sm hidden-xxs">
							<li><a href="https://www.facebook.com/anmythic?locale=vi_VN"><i class="fa fa-facebook"></i></a></li>
