										...
										<li class="col-md-6">
											...
											<div class="post--item post--layout-2">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home2[0]->author->name ?? 'Unknown Author'}}</a></li>
															...
															<div class="post--img">
																...
																<div class="post--info">
																	<ul class="nav meta">
																		...
																		<li><a href="javascript:;">{{ $post_category_home2[$i]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li class="col-xs-12">
											...
											<div class="post--item post--layout-1">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home3[0]->author->name ?? 'Unknown Author'}}</a></li>
											...
											<li class="col-xs-6">
												...
												<div class="post--item post--layout-2">
													<div class="post--img">
														...
														<div class="post--info">
															<ul class="nav meta">
																<li><a href="javascript:;">{{ $post_category_home3[$i]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li>
											...
											<div class="post--item post--layout-1">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home4[0]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li>
											...
											<div class="post--item post--layout-3">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home4[$i]->author->name ?? 'Unknown Author'}}</a></li>
							...
							<div class="social--widget style--2">
								<ul class="nav row gutter--20">
									<li class="col-md-12 facebook">
										<a href="https://www.facebook.com/anmythic">
											<span class="icon">
						...
						<li class="col-md-8">
							...
							<div class="post--item post--layout-1 post--type-video post--title-large">
								<div class="post--img">
									...
									<div class="post--info">
										<ul class="nav meta">
											<li><a href="javascript:;">{{ $post_category_home5[0]->author->name ?? 'Unknown Author'}}</a></li>
								...
								<li>
									...
									<div class="post--item post--type-audio post--layout-3">
										<div class="post--img">
											...
											<div class="post--info">
												<ul class="nav meta">
													<li><a href="javascript:;">{{ $post_category_home5[$i]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li>
											...
											<div class="post--item post--layout-1">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home6[0]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li>
											...
											<div class="post--item post--layout-3">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home6[$i]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li class="col-xs-12">
											...
											<div class="post--item post--layout-1">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home7[0]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li class="col-xs-6">
											...
											<div class="post--item post--layout-2">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home7[$i]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li class="col-md-6">
											...
											<div class="post--item post--layout-2">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home8[0]->author->name ?? 'Unknown Author'}}</a></li>
													...
													<li class="col-xs-6">
														...
														<div class="post--item post--layout-2">
															<div class="post--img">
																...
																<div class="post--info">
																	<ul class="nav meta">
																		<li><a href="javascript:;">{{ $post_category_home8[$i]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li class="col-md-12">
											...
											<div class="post--item post--layout-1 post--title-large">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home9[0]->author->name ?? 'Unknown Author'}}</a></li>
										...
										<li class="col-md-4 col-xs-6 col-xxs-12">
											...
											<div class="post--item post--layout-1">
												<div class="post--img">
													...
													<div class="post--info">
														<ul class="nav meta">
															<li><a href="javascript:;">{{ $post_category_home9[$i]->author->name ?? 'Unknown Author'}}</a></li>
			...
			<div class="block-21 d-flex animate-box post">
				...
				<div class="text">
					...
					<div class="meta">
						...
						<div><a href="javascript:;"><span class="icon-user2"></span>{{ $post->author->name ?? 'Unknown Author'}} </a></div>
